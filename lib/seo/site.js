...
export const SITE = {
  ...
  description:
    'VibeAlerts routes website form submissions to Telegram, Email, Slack, Discord, and more. Works with WordPress, Wix, Webflow, Shopify, Typeform, Google Forms, and any site that can POST JSON.',
  locale: 'en_US',
