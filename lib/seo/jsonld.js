...
import { getSupportEmail, getSubscriptionPriceLabel } from '@/lib/legal/site';
...
export function buildSoftwareApplicationSchema() {
  ...
  const price = priceMatch ? priceMatch[1] : '15';
  ...
  return {
    ...
    offers: {
      ...
      price,
      priceCurrency: 'USD',
      description: `Monthly subscription — ${priceLabel}`,
  ...
  return [
    {
      ...
      answer:
        'VibeAlerts is a SaaS webhook service that forwards website form submissions to Telegram, Email, Slack, Discord, Teams, or WhatsApp. It works with WordPress, Wix, Webflow, Shopify, Typeform, Google Forms, and custom HTML forms.',
    },
    {
