...
export const LEGAL = {
  ...
  serviceDescription:
    'VibeAlerts is a hosted software subscription that forwards website form submissions to notification channels such as Telegram, Email, Slack, Microsoft Teams, and WhatsApp.',
