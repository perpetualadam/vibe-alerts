...
export class ShopifyIntegration extends PlatformIntegration {
  ...
  static description =
    'Shopify App (OAuth) with automatic webhooks — plus optional Flow / Liquid fallbacks';
  static version = '2.0.0';
  static setupSteps = [
    'Recommended — Shopify App: open Dashboard → Shopify App, enter your *.myshopify.com domain, click Install.',
    'Authorize VibeAlerts on Shopify. Webhooks for your selected events subscribe automatically (orders, customers, refunds, abandoned carts + GDPR).',
    'Choose which events trigger notifications in the Shopify App panel, then Save event preferences.',
    'App Store / Partner installs land on /install/shopify?shop=… and continue to OAuth.',
    'Optional fallback — Shopify Flow HTTP request or theme contact form still work via webhook URL + API key (see below).',
  ];
