...
export class WixIntegration extends PlatformIntegration {
  ...
  static setupSteps = [
    'Option A — Wix Automations: Trigger → Form submitted → Send HTTP request.',
    'Set URL to your VibeAlerts webhook URL.',
    'Add header X-VibeAlerts-Platform: wix and X-VibeAlerts-Key: your API key.',
    'Option B — Velo: copy integrations/wix/vibe-alerts.web.js into your site backend.',
  ];
